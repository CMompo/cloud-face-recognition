...
def parse_args():
    parser = argparse.ArgumentParser(prog="Embeddings Generator",
    description="Script for generating face embeddings. Output of this script is 'embeddings.txt' which contains embeddings "
